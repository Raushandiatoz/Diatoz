...
function update_check(sq_version){
	...
	$.ajax({
		...
		success: function(data){
			...
			var msg="<div class='alert alert-danger'>New version available: LNT Quiz v"+data.trim()+". You are using outdated version of LNT v"+sq_version+". Visit <a href='http://savsoftquiz.com'>www.savsoftquiz.com</a> to download</div>";	
