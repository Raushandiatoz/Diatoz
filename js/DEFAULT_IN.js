...
function update_check(sq_version){
	...
	$.ajax({
		...
		success: function(data){
			...
			var msg="<div class='alert alert-success'>You are using updated version of <a href='#'>LNT Quiz "+sq_version+"</a></div>";	
			}else{
			var msg="<div class='alert alert-danger'>New version available: LNT Quiz v"+data.trim()+". You are using outdated version of LNT Quiz v"+sq_version+". Visit <a href='#'>LNT</a> to download</div>";	
