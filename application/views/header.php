...
<?php 
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://[::1]/Diatoz/index.php/dashboard">
         
        <img src="http://localhost/Diatoz/C.png"> 
		
      </a>
<center><span style="color:#155186;"><?php echo $hres[1]['setting_value'];?> </span></center>
      <!-- Divider -->
...
?> 
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseQuiz" aria-expanded="true" aria-controls="collapseQuiz">
          ...
          <span><?php # echo $this->lang->line('sdfds');?>Online Assessment Battery</span>
        </a>
...
if(in_array('List',explode(',',$logged_in['quiz'])) || in_array('List_all',explode(',',$logged_in['quiz']))){
?>  
            <a class="collapse-item" href="<?php echo site_url('quiz');?>"><?php #echo $this->lang->line('quiz');?> <?php #echo $this->lang->line('list');?>Online Assessment List</a>
<?php 
}
?>
...
<?php 
if(in_array('List',explode(',',$logged_in['psychometric'])) || in_array('List_all',explode(',',$logged_in['psychometric']))){
?> 
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePsychometric" aria-expanded="true" aria-controls="collapsePsychometric">
          <i class="fas fa-fw fa-chalkboard-teacher"></i>
          <span><?php echo $this->lang->line('psychometric');?> </span>
        </a>
        <div id="collapsePsychometric" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
 <?php  
 if(in_array('Add',explode(',',$logged_in['psychometric']))){
 ?>            
            <a class="collapse-item" href="<?php echo site_url('psychometric/add_new');?>"><?php echo $this->lang->line('add_new');?></a>
		<?php
		}
if(in_array('List',explode(',',$logged_in['psychometric'])) || in_array('List_all',explode(',',$logged_in['psychometric']))){
?>  
            <a class="collapse-item" href="<?php echo site_url('psychometric');?>"><?php echo $this->lang->line('psychometric');?> <?php echo $this->lang->line('list');?></a>
<?php 
}
?>
