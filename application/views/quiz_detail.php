 ...
 <h3><?php # echo $title;?>Attempt Online Assessment Test</h3>
...
<tr><td><?php #echo $this->lang->line('quiz_name');?>Online Assessment Test Name</td><td><?php echo $quiz['quiz_name'];?></td></tr>
<tr><td colspan='2'><?php echo $this->lang->line('description');?><br><?php echo $quiz['description'];?></td></tr>
<tr><td><?php #echo $this->lang->line('start_date');?>Start Date (Online Assessment Test can be attempted after this date. YYYY-MM-DD HH:II:SS )</td><td><?php echo date('Y-m-d H:i:s',$quiz['start_date']);?></td></tr>
<tr><td><?php #echo $this->lang->line('end_date');?>End Date (Online Assessment Test can be attempted before this date. eg. 2017-12-31 23:59:00 )</td><td><?php echo date('Y-m-d H:i:s',$quiz['end_date']);?></td></tr>
