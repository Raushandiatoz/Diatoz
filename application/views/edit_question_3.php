...
?>
			...
			<div class="form-group">	 
					...
					<input  name="paragraph"  class="form-control"   ><?php echo $question['paragraph'];?></input>
			</div>
...
?>			
			...
			<div class="form-group">	 
					...
					<input  name="question"  class="form-control"   ><?php echo $question['question'];?></input>
			</div>
			<div class="form-group">	 
					<label for="inputEmail"  ><?php echo $this->lang->line('description');?></label> 
					<input  name="description"  class="form-control"><?php echo $question['description'];?></input>
			</div>
