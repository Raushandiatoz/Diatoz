...
<div class="col-lg-6">
			<div class="form-group">	 
					...
					<input  name="paragraph<?php echo $lno;?>"  class="form-control"   ><?php echo $question['paragraph'.$lno];?></input>
			</div>
...
<div class="col-lg-6">			
			...
			<div class="form-group">	 
					...
					<input  name="question<?php echo $lno;?>"  class="form-control"   ><?php echo $question['question'.$lno];?></input>
			</div></div>
			 <?php 
}
foreach($lang as $lkey =>$val){	
...
?>	<div class="col-lg-6">		
			...
			<div class="form-group">	 
					...
					<input  name="description<?php echo $lno;?>"  class="form-control"><?php echo $question['description'.$lno];?></input>
			</div>
...
?>
			...
			<div class="form-group">	 
					...
					<br><input  name="option<?php echo $lno;?>[]"  class="form-control"  ><?php echo $val['q_option'.$lno];?></input>
			</div>
			</div>
		<?php
}	
