...
<div class="col-lg-6">
			...
			<div class="form-group">	 
					...
					<input  name="paragraph<?php echo $lno;?>"  class="form-control"   ><?php
	if(isset($qp)){ echo $qp['paragraph'.$lno]; } ?></input>
			</div>
			</div>
...
<div class="col-lg-6">			
			...
			<div class="form-group">	 
					...
					<input  name="question<?php echo $lno;?>"  class="form-control"   ></input>
			</div>
			</div>		
 <?php 
}
...
?>	<div class="col-lg-6">		
			...
			<div class="form-group">	 
					...
					<input  name="description<?php echo $lno;?>"  class="form-control"></input>
			</div>
			</div>		
			<?php 
}
...
?>
			...
			<div class="form-group">	 
					...
					<?php } ?>
					<br><input  name="option<?php echo $lno;?>[]"  class="form-control"   ></input>
			</div>
			</div>
		<?php
}	
