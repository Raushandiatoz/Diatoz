                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
					  ...
					  <?php #echo $this->lang->line('no_registered_quiz');?>NUMBER OF ONLINE ASSESSMENT TEST AVAILABLE 
						</a>					  
						</div>
...
<?php 
echo "Page rendered in <strong> {elapsed_time} </strong> seconds. You may improve it by hosting on recommended hosting. <a href='#' target='af'>Click here</a> ";
?>
</div>
