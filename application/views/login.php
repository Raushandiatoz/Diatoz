...
<head>
 ...
 <style>
   body {
  background-image: url('http://localhost/Diatoz/Group_back.png');
  background:cover;
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block  " ><a href="http://[::1]/Diatoz/index.php/login"><img src="http://127.0.0.1/Diatoz/Group_icon.png"/></a></div>
              <div class="col-lg-6">
                <div class="p-5">
				...
				?>
					...
					<?php if($hres[0]['setting_value']==""){ ?><?php }else{ echo $hres[0]['setting_value']; }?> 
...
if($this->config->item('open_quiz')){
	?>			 
			&nbsp;&nbsp;&nbsp;<a class="small" href="<?php echo site_url('quiz/open_quiz/0');?>"  ><?php #echo $this->lang->line('open_quizzes');?>Open Online Assessment Test</a>
			...
			?>
				  ...
				  <p style="margin-top:40px;""><a class="small" href="http://[::1]/Diatoz/index.php/login" style="float:right;">Powered by LNT</a></p>
